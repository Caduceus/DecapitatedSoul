<?php
	...
	$config['site_title'] = 'Decapitated Soul';
	$config['site_title_context'] = 'Welcoming new players to our family, not our clientele!';
	$config['site_url'] = "http://decapitatedsoul.servegame.com";

	// Path to server folder without / Example: C:\Users\Alvaro\Documents\GitHub\forgottenserver
	$config['server_path'] = 'C:\Open Tibia\Decap 10.95'; 
	...
	function getClock($time = false, $format = true, $adjust = false) {
		if ($time === false) $time = time();
		// Date string representation
		$date = "d_F_Y"; // 22 May 2018 (02:56) displays time --(H:i)
		if ($adjust) $adjust = (1 * -32400); // Adjust to fit your timezone. (1 * -25200)
		else $adjust = 0;
	...
	$config['powergamers'] = array(
		...
		'limit' => 10, //Number of players that it will show.
	);
	...
	$config['houseConfig'] = array(
		...
		'minimumBidSQM' => 20000, // minimum bid cost on auction (per SQM)
	...
	*/
	...
	//$config['available_vocations'] = array(1, 2, 3, 4, 9);
	$config['available_vocations'] = array(1, 2, 3, 4, 9);
	...
	$config['highscore'] = array(
			'rows' => 100,
			'rowsPerPage' => 10,
			'ignoreGroupId' => 3, // Ignore this and higher group ids (staff)
		);
	...
	$config['client'] = 1095; // 954 = client 9.54
	...
	$config['gameserver'] = array(
		'ip' => 'decapitatedsoul.servegame.com',
		'port' => 7172,
		'name' => 'Decapitated Soul' // Must be identical to config.lua (OT config file) server name.
	);
	...
	$config['website_char'] = 'God Caduceus';
	...
	*/
	...
	$config['paypal'] = array(
		...
		'email' => 'decapitatedsoulot@gmail.com',
		'client_id' => 'AUnQ-t-UJUITbBQNu7AZYLN2SLEcV72utdd3seQ4hqMVdVRW34xm_Cn_t1ONbQpPwhfk_jGScXSyah99',
		'secret_id' => 'ENBmjJto9CRzXOSmnO7PMMJnXZnHcg64MOTY2uW-DipLslduPkjTpvwMqncneiMjSA0PGpTyTI5Ykvpp',
		'currency' => 'USD',
		'points_per_currency' => 1, // 1 currency = ? points? [ONLY used to calculate bonuses]
	...
	*/
	$config['shop_offers'] = array(
		...
		1 => array(
			'type' => 1,
			'itemid' => 10135, // Item to display on page
			'count' => 1,
			'description' => "1 Day VIP",
			'points' => 15,
		),
		2 => array(
			'type' => 1,
			'itemid' => 10134, // Item to display on page
			'count' => 1,
			'description' => "5 Days VIP",
			'points' => 30,
		),
		3 => array(
			'type' => 1,
			'itemid' => 10133, // Item to display on page
			'count' => 1,
			'description' => "10 Days VIP",
			'points' => 45,
		),
		
		4 => array(
			'type' => 1,
			'itemid' => 2300, // Item to display on page
			'count' => 5,
			'description' => "Blessing Rune",
			'points' => 10,
		),
		
		5 => array(
			'type' => 1,
			'itemid' => 1948, // Item to display on page
			'count' => 1,
			'description' => "Double XP Scroll (1 hour)",
			'points' => 15,
		),
		
		6 => array(
			'type' => 1, // 1 = item id offers, 2 = premium days [itemid ignored], 3 = sex change[itemid & count ignored], 4+ = custom.
			'itemid' => 15515, // item to get in-game
			'count' => 1, //if type is 2, this represents premium days
			'description' => "Gold Bar", // Description shown on website
		...
		8 => array(
			'type' => 1,
			'itemid' => 2361, // Item to display on page
			'count' => 1,
			'description' => "Starlight Portal",
			'points' => 40,
		),
		...
		9 => array(
			...
			'itemid' => 7762,
			'count' => 1,
			'description' => "Enchanted Amethyst (energy)",
			'points' => 3,
		),
		...
		10 => array(
			...
			'itemid' => 7761,
			'count' => 1,
			'description' => "Enchanted Emerald   (earth)",
			'points' => 3,
		),
		...
		11 => array(
			...
			'itemid' => 7760,
			'count' => 1,
			'description' => "Enchanted Ruby   (fire)",
			'points' => 3,
		),
		...
		12 => array(
			...
			'itemid' => 7759,
			'count' => 1,
			'description' => "Enchanted Sapphire   (ice)",
			'points' => 3,
		),
