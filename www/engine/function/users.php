...
function user_create_account($register_data, $maildata) {
	...
	mysql_insert("INSERT INTO `account_viplist` (`account_id`, `player_id`, `description`, `icon`, `notify`) VALUES ('$account_id', '1', 'Dev', '5', '1')");
	mysql_insert("INSERT INTO `account_viplist` (`account_id`, `player_id`, `description`, `icon`, `notify`) VALUES ('$account_id', '2', 'Staff', '5', '1')");
	mysql_insert("INSERT INTO `account_viplist` (`account_id`, `player_id`, `description`, `icon`, `notify`) VALUES ('$account_id', '6', 'Dev', '5', '1')");
