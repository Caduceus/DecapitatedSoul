...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONST_ME_JUMPING_GOLDFISH)
	registerEnum(CONST_ME_BLUE_STATIC)
	registerEnum(CONST_ME_ORANGE_STATIC)
	registerEnum(CONST_ME_GREEN_STATIC)
	registerEnum(CONST_ME_RED_STATIC)
	registerEnum(CONST_ME_WHITE_STATIC)
	registerEnum(CONST_ME_YELLOW_STATIC)
	registerEnum(CONST_ME_MAGIC_YELLOW)
	registerEnum(CONST_ME_FAIRY_DUST)
	registerEnum(CONST_ME_FAIRY_TO)
	registerEnum(CONST_ME_FAIRY_AWAY)
	registerEnum(CONST_ME_STORM_CLOUD)
	registerEnum(CONST_ME_FALLING_STONE)
	registerEnum(CONST_ME_GHOST_BLUE)
	registerEnum(CONST_ME_PINK_RING)
	registerEnum(CONST_ME_SCROLL)
	registerEnum(CONST_ME_PINK_CRASH)
	registerEnum(CONST_ME_BLOOD_DRIP)
	registerEnum(CONST_ME_BLOOD_BURST)
	registerEnum(CONST_ME_PURPLE_EXPLOSION)
	registerEnum(CONST_ME_HOLY_JUDGEMENT)
	registerEnum(CONST_ME_FLOATING_BOX)
	registerEnum(CONST_ME_HITBYDEATH)
	registerEnum(CONST_ME_MAGIC_MULTI)
	registerEnum(CONST_ME_UNKNOWN)
	registerEnum(CONST_ME_UNKNOWN2)
	registerEnum(CONST_ME_SPIRIT_RELEASE)
