...
{    name = "Mounts",
        ...
        offers = {
            ...
            --{name = "Fleeting Knowledge", thingId = 130, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 50, icons = {"Product_Mount_FleetingKnowledge.png"}, description = "Fleeting Knowledge Mount! +60 Speed"},
