...
{    name = "Outfits", -- druid hunter warrior mage knight pirate not included
        ...
        offers = {
            ...
            {name = "Retro Citizen Addon", thingId = {male=974,female=975}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroCitizen_Male.png", "Product_Outfit_RetroCitizen_Female.png"}},
            {name = "Retro Hunter Addon", thingId = {male=972,female=973}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroHunter_Male.png", "Product_Outfit_RetroHunter_Female.png"}},
            {name = "Retro Knight Addon", thingId = {male=970,female=971}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroKnight_Male.png", "Product_Outfit_RetroKnight_Female.png"}},
            {name = "Retro Mage Addon", thingId = {male=968,female=969}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroMage_Male.png", "Product_Outfit_RetroMage_Female.png"}},
            {name = "Retro Noble Person Addon", thingId = {male=966,female=967}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroNobleman_Male.png", "Product_Outfit_RetroNoblewoman_Female.png"}},
            {name = "Retro Summoner Addon", thingId = {male=964,female=965}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroSummoner_Male.png", "Product_Outfit_RetroSummoner_Female.png"}},
            {name = "Retro Warrior Addon", thingId = {male=962,female=963}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 5, icons = {"Product_Outfit_RetroWarrior_Male.png", "Product_Outfit_RetroWarrior_Female.png"}},
