...
{    name = "Mounts",
        ...
        offers = {
            ...
            {name = "Moldpincer", thingId = 95, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 40, icons = {"Product_Mount_Moldpincer.png"}, description = "Moldpincer Mount! +50 Speed"}, 
            ...
            {name = "Mould Shell", thingId = 100, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 40, icons = {"Product_MountMould Shell.png"}, description = "Mould Shell Mount! +50 Speed"}, 
