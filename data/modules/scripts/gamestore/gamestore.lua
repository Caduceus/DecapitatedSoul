...
{    name = "Mounts",
        ...
        offers = {
            ...
            {name = "Lion", thingId = 40, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 20, icons = {"Product_Mount_Lion.png"}, description = "A Lion Mount! +30 Speed"},
            {name = "Golden Lion", thingId = 41, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 20, icons = {"Product_Mount_GoldenLion.png"}, description = "Golden Lion Mount! +30 Speed"},
            ...
            {name = "Dominus Draptor", thingId = 83, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 40, icons = {"Product_Mount_DominusDraptor.png"}, description = "Dominus Draptor Mount! +50 Speed"}, 
