...
{    name = "Outfits",
        ...
        offers = {
            ...
            {name = "Citizen Addon", thingId = {male=128,female=136}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 0, icons = {"Outfit_Citizen_Male_Addon_3.gif"}},
            {name = "Nobleman Addon", thingId = {male=132,female=140}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 0, icons = {"Outfit_Citizen_Male_Addon_3.gif"}},
            {name = "Beggar Addon", thingId = {male=153,female=157}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 0, icons = {"Outfit_Citizen_Male_Addon_3.gif"}},
            {name = "Norseman Addon", thingId = {male=251,female=252}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 0, icons = {"Outfit_Citizen_Male_Addon_3.gif"}}
        }
    },
--[[{    name = "FREE Mounts",
        state = GameStore.States.STATE_NEW,
