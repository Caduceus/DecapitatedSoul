		...
		if creature:getStorageValue(1016) == 1 then
			if creature:getStorageValue(1017) == 1 then
				if creature:getStorageValue(1018) == 1 then
					creature:sendTextMessage(MESSAGE_EVENT_ADVANCE, 'All the Maps are Burnt. Collect Red Beard\'s hook, Then Return to Javy Dones!')
					...
					creature:setStorageValue(2239, 5) -- storage of Pirate Boss Chain Advance
