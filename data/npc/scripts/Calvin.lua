...
keywordHandler:addKeyword({'sorcerer'}, StdModule.say, {npcHandler = npcHandler, text = "Sorcerers may wear {yalahari mask}, {yalahari armor}, {yalahari legs}, and {yalahari boots}."})
keywordHandler:addKeyword({'druid'}, StdModule.say, {npcHandler = npcHandler, text = "Druids may wear {yalahari mask}, {yalahari armor}, {yalahari legs}, and {yalahari boots}."})
keywordHandler:addKeyword({'paladin'}, StdModule.say, {npcHandler = npcHandler, text = "Paladins may wear {gladiator helmet}, {calopteryx cape}, {grasshopper legs}, and {grasshopper boots}."})
