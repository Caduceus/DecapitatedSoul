...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(Storage.thievesGuild.Mission06) == 4 then
			npcHandler:say('Have you finished your mission?', cid)
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(8766, 1) then
				player:setStorageValue(Storage.thievesGuild.Mission06, 5)
		...
		elseif npcHandler.topic[cid] == 9 then
			...
			npcHandler:say({
				'Once again you\'ve finished your job, and I\'ll keep my promise. From now on, you can trade with old Black Bert somewhere upstairs to get access to certain items that might be of value to someone like you. ...',
