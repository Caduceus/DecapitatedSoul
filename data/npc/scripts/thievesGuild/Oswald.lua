...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') then
		if npcHandler.topic[cid] == 1 then
			npcHandler:say('Well, rich and generous people are always welcome in the palace. If you donate a gold bar to a fund I oversee, I\'ll give you an invitation, ok?', cid)
			npcHandler.topic[cid] = 3
		elseif npcHandler.topic[cid] == 3 then
			if player:removeMoneyNpc(1000000) then
	...
	elseif msgcontains(msg, 'gold') then
		if npcHandler.topic[cid] == 1 then
			npcHandler:say('Not that I am bribeable but I doubt that you own 1000000 gold pieces. Or do you?', cid)
