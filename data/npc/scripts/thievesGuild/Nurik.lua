...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'Vlad tower') then
		npcHandler:say('Wait a minute! Do I get that right? You\'re the owner of Vlad Tower and you are willing to sell it to me??', cid)
		npcHandler.topic[cid] = 1
	elseif msgcontains(msg, 'yes') then
		if npcHandler.topic[cid] == 1 then
			npcHandler:say({
				'That\'s just incredible! I\'ve dreamed about acquiring the tower since I was a child! Now my dream will finally become true. ...',
		...
		elseif npcHandler.topic[cid] == 3 then
			npcHandler:say('Oh my, oh my. I\'m so excited! So let\'s seal this deal as fast as possible so I can start moving in. Are you ready for the transaction?', cid)
