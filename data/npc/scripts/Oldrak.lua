...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'mission') or msgcontains(msg, 'demon oak') then
		...
		elseif player:getStorageValue(Storage.DemonOak.Progress) == 2 and player:getStorageValue(Storage.DemonOak.Done) < 1 then
			npcHandler:say("You better not return here until you've defeated the Demon Oak.", cid)
		elseif player:getStorageValue(Storage.DemonOak.Done) == 1 then
			npcHandler:say({
				...
				"For your brave action, I will tell you a secret which has been kept for many many years. There is an old cemetery just south of here. There should be a grave with the name 'Dr. Henry Walton Jones' somewhere close by. ...",
				"It belongs to an adventurer, just like you. I knew him well. He told me -almost augured- that someone will come who is worthy to obtain this treasure. I'm sure this 'someone' is you. Good luck in finding it!"
			}, cid)
