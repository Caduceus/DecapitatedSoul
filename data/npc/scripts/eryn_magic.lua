...
shopModule:addBuyableItemContainer({'bp shp'}, 21483, 7591, 350000, 100, 'backpack of scaling health potions')
...
shopModule:addBuyableItemContainer({'bp ssp'}, 21485, 8472, 350000, 100, 'backpack of scaling spirit potions')
...
shopModule:addBuyableItemContainer({'bp smp'}, 21484, 7590, 350000, 100, 'backpack of scaling mana potions')
