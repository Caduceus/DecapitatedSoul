...
npcHandler:setMessage(MESSAGE_GREET, "Good day, |PLAYERNAME|, Thank you for joining Decapitated Soul. We have several {quests} in store for you.")

local missions = {
	[1] = {
     items = {
     {id = 2696, count = 10} -- Cheese
     },
    monsters = {
       {name = "rat", count = 15, storage = 21906},
     },
     message = "I need you to:", 
     level = 1, -- minimum level for this mission
     rewarditems = {
       {id = 2160, count = 1}
     },
     rewardexp = 50
...
function creatureSayCallback(cid, type, msg)
     ...
     if msgcontains(msg, 'mission') or msgcontains(msg, 'quest') then
         ...
         elseif x then
             ...
             selfSay("Make your way {South} to {Bacchus Landing} Gate. Several others may need your assistance along your way, in oder to enter {Drogheda}. Good Luck, friend!", cid)
