...
npcHandler:setMessage(MESSAGE_GREET, "Good day, |PLAYERNAME|, looking for a little action? I may have just the {quest} for you!")

local missions = {
	[1] = {
     items = {
       {id = 5911, count = 10}, -- red cloth
       {id = 12406, count = 12},  -- little black book
       {id = 2744, count = 1}  -- red rose
     },
    monsters = {
       {name = "hero", count = 20, storage = 21905},
     },
     message = "If you {Really} like me, you will get me...", 
     level = 45, -- minimum level for this mission
     rewarditems = {
       {id = 2160, count = 5}
     },
     rewardexp = 12000
...
function creatureSayCallback(cid, type, msg)
     ...
     if msgcontains(msg, 'mission') or msgcontains(msg, 'quest') then
         if player:getStorageValue(storage) == -1 then
             selfSay("Welllll, I may have a challenge for you. Are you up for it??", cid)
