local elevatorPosition = {
	Position(1072, 1008, 9),
	Position(1072, 1008, 10)
}
...
local config = {
	[1] = {
		...
		sound = 'Srrrt!',
		soundPosition = Position(1072, 1008, 9),
		relocatePosition = Position(1072, 1008, 9)
	},
	[2] = {
		...
		sound = 'Zrrrt!',
		soundPosition = Position(1072, 1008, 10),
		relocatePosition = Position(1072, 1008, 10)
	}
}
...
local function moveElevator(config, player)
	...
	if player then
		player:say(config.sound, TALKTYPE_MONSTER_SAY, false, player, config.soundPosition)
	end
end
