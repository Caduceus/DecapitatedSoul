...
local arena = {
	...
	exitpos = {x = 1106, y = 994, z = 9}
}
local checkpvparena = true -- checks if someone is blocking the arena
local duel_limit = 10 * 60 -- in seconds
local player1pos = {x = 1062, y = 962, z = 14}
local leverpos = {x = 1062, y = 963, z = 14}
local player2pos = {x = 1062, y = 964, z = 14}
local nplayer1pos = {x = 1065, y = 966, z = 15}
local nplayer2pos = {x = 1076, y = 959, z = 15}
-- CONFIG ENDS HERE --
