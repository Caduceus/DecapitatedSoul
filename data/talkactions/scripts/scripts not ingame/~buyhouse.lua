function onSay(player, words, param)
	...
	player:sendTextMessage(MESSAGE_INFO_DESCR, "You have successfully bought this house. Inactively for more than 30 days, will result in foreclosure of all property.")
	return false
end
